...
const sPGarmentOptions = Object.values(hoodieGarments);

export default function SPHoodieGarmentSelect({ onNext, onPrevious, selectedSPGarment, setSelectedSPGarment }) {
    useEffect(() => {
    ...
    return (
        <>
            <div className='slide-header'>
                <h1 className='text-3xl font-bold headingColor'>Pick Your Hoodie</h1>
