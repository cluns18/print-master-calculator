...
const sPGarmentOptions = Object.values(tshirtGarments);

export default function SPtshirtGarmentSelect({ onNext, onPrevious, selectedSPGarment, setSelectedSPGarment }) {
    useEffect(() => {
