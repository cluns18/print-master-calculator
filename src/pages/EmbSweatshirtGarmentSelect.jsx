...
const garmentOptions = Object.values(hoodieGarments);

export default function EmbSweatshirtGarmentSelect({ onNext, onPrevious, selectedEmbGarment, setSelectedEmbGarment }) {
    useEffect(() => {
    ...
    return (
        <>
            <div className='slide-header'>
                <h1 className='text-3xl font-bold headingColor'>Pick Your Sweatshirt</h1>
